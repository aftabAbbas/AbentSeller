...
import com.aftab.abentseller.Activities.Main.CanceledOrderActivity
...
import com.aftab.abentseller.databinding.CanceledOrderItemBinding

class CanceledOrderAdapter(var context: Context, private var productList: ArrayList<ProductOrder>) :
    RecyclerView.Adapter<CanceledOrderAdapter.VH>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        return VH(
            LayoutInflater.from(parent.context).inflate(R.layout.canceled_order_item, parent, false)
        )
    }
    ...
    class VH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val binding = CanceledOrderItemBinding.bind(itemView)
        ...
        fun setData(context: Context, productOrder: ProductOrder) {
            ...
            binding.cvItem.setOnClickListener {
                ...
                context.startActivity(
                    Intent(context, CanceledOrderActivity::class.java)
