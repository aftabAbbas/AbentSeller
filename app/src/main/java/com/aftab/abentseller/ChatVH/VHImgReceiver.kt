...
class VHImgReceiver(itemView: View) : RecyclerView.ViewHolder(itemView) {
    private var ivImgReceiver: ImageView = itemView.findViewById(R.id.iv_img_receiver)
    private var tvTimeReceiver: TextView = itemView.findViewById(R.id.tv_time)
    ...
    fun setData(
        ...
        if (arrayList[position].msg != null) {
            ...
            tvTimeReceiver.text = getTime(arrayList[position].dateTime)
        }
