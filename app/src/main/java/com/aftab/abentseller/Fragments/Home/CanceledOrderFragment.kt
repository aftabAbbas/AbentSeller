...
import com.aftab.abentseller.Adapters.Recycler.CanceledOrderAdapter
...
import com.aftab.abentseller.databinding.FragmentCanceledOrderBinding
import com.google.firebase.firestore.DocumentSnapshot

class CanceledOrderFragment : Fragment() {


    private lateinit var binding: FragmentCanceledOrderBinding
    private lateinit var canceledOrderAdapter: CanceledOrderAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentCanceledOrderBinding.inflate(layoutInflater, container, false)
        initUI()
        getCanceledOrders()
    ...
    private fun initUI() {
        ...
        binding.srlCanceledOrder.setOnRefreshListener(this::getCanceledOrders)

    }

    private fun getCanceledOrders() {

        binding.srlCanceledOrder.isRefreshing = true
        ...
        FireRef.ORDER_REF
            ...
            .addOnFailureListener {
                ...
                binding.srlCanceledOrder.isRefreshing = false
    ...
    private fun setAdapter() {
        ...
        canceledOrderAdapter = CanceledOrderAdapter(this.mContext, productList)
        binding.rvCanceledOrder.adapter = canceledOrderAdapter
