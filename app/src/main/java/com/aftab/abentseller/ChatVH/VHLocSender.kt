...
class VHLocSender(itemView: View) : RecyclerView.ViewHolder(itemView), OnMapReadyCallback {
    var context: Context? = null
    var cardView: CardView = itemView.findViewById(R.id.cv_send_location)
    private var mapView: MapView? = itemView.findViewById(R.id.mv_send_loc)
    private var tvLocation: TextView = itemView.findViewById(R.id.tv_send_location)
