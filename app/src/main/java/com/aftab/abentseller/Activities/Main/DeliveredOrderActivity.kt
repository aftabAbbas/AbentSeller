...
import com.aftab.abentseller.databinding.ActivityDeliveredOrderBinding
...
class DeliveredOrderActivity : AppCompatActivity() {


    private lateinit var binding: ActivityDeliveredOrderBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDeliveredOrderBinding.inflate(layoutInflater)
